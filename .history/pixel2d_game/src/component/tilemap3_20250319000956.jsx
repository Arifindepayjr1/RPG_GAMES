...
const Tilemap3 = () => {
  ...
  useEffect(() => {
    ...
    tileset.src = '/222.png'; // Adjust path based on your project structure
    ...
    const drawMap = () => {
      ...
      objects.forEach(obj => {
        if (obj.visible) {
          ...
          if (tilePos) {
            // Convert pixel coordinates to tile coordinates with pixel offsets
  ...
  }, [baseLayer, objects]); // Dependencies: baseLayer and objects
