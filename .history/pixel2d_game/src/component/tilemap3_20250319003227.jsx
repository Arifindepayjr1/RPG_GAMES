...
const Tilemap3 = () => {
  ...
  const rawMap = [
    ...
    23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 2, 15, 15, 15, 15, 15, 15, 2, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23,
    23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 2, 15, 15, 15, 15, 15, 15, 2, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23,
    23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 3, 15, 15, 15, 15, 4, 1, 3, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23,
    23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 15, 2, 15, 15, 2, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23,
    23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23,
    23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23,
    23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23,
    23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23,
    ...
    const drawMap = () => {
      ...
      for (let row = 0; row < 20; row++) {
        for (let col = 0; col < 30; col++) {
          ...
          ctx.drawImage(
            ...
            col * TILE_SIZE, row * TILE_SIZE, // Destination x, y (exact multiples of 32)
      ...
      objects.forEach(obj => {
        if (obj.visible) {
          ...
          if (tilePos) {
            // Scale object coordinates precisely
            const x = Math.round((obj.x / 16) * TILE_SIZE); // Round to avoid subpixel gaps
            const y = Math.round((obj.y / 16) * TILE_SIZE);
            ctx.drawImage(
              tileset,
              tilePos.x, tilePos.y,
              16, 16,
