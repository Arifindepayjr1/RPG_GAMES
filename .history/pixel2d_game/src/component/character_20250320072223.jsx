import { SPRITE_WIDTH, SPRITE_HEIGHT, BORDER_WIDTH, SPACING_WIDTH, CHARACTER_DISPLAY_SIZE, CHARACTER_SPEED, TILE_SIZE } from '../constants.jsx';
  ...
  const updateAnimation = (isMoving) => {
    ...
    if (character.isFighting) {
      if (character.frameCount % 10 === 0) {
        ...
        character.isFighting = newFrameX !== 0;
      }
