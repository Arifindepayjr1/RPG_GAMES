...
const Tilemap1 = () => {
  ...
  useEffect(() => {
    console.log("Tilemap1 mounted, setting up canvas");
    const canvas = canvasRef.current;
    const ctx = canvas.getContext("2d");
    const tileset = new Image();
    tileset.src = tilemapImage;

    console.log("Tileset src set to:", tileset.src);
    ...
    const rawMap = [
      ...
      [12, 12, 12, 12, 12, 12, 12, 12, 12, '22/*itemID33*/', 22, 22, 22, 22, 89, 22, 22, 22, 22, 22, 22, 22, 22, 22, '22/*itemID43*/', 12, '12/*itemID35*/', 12, 12, 13],
  ...
  return (
    <canvas
      ...
      style={{
        ...
        border: "1px solid white", // White border to see the canvas on black background
        background: "gray", // Fallback to see if canvas renders
      }}
    />
  );
};
