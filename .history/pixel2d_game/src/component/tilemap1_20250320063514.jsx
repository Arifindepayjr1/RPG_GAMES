   ...
   const rawMap = [
    ...
    const drawMap = () => {
      if (!tileset.complete || tileset.naturalWidth === 0) {
        console.log("Tileset not loaded, retrying...");
        setTimeout(drawMap, 100);
        return;
      }
      console.log("Tileset loaded, drawing tilemap");
      console.log("Tileset dimensions:", tileset.naturalWidth, tileset.naturalHeight);
    ...
    tileset.onload = () => {
      console.log("Tileset onload triggered");
      drawMap();
    };
