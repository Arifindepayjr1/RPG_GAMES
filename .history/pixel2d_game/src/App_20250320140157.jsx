...
import Tilemap2 from "../src/component/tilemap2"; // Adjust path as needed
import Tilemap3 from "../src/component/tilemap3"; // Adjust path as needed

const App = () => {
  const [gameStarted, setGameStarted] = useState(false);
  const [currentMap, setCurrentMap] = useState("tilemap1");
  const [characterPos, setCharacterPos] = useState({ x: 5 * 32, y: 5 * 32 }); // Start in Tilemap1 (middle-ish)
  ...
  return (
    <div
      style={{
        ...
        padding: 0,
        overflow: "hidden",
        background: "gray", // Background for borders
      }}
    >
      {!gameStarted ? (
