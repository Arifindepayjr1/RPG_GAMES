...
export const blockingBaseTiles = [1, 2, 3, 4, 5, 6, 8, 11, 13, 16, 18, 19, 21, 22, 23, 31, 36, 49, 50, 51, 54, 57, 59, 60, 77];
export const blockingItemIDs = [25, 26, 27, 33, 35, 37, 41, 42, 43, 45, 48, 56, 61];
...
export const rawMap3 = [
  ...
  [23, 22, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, '15/*itemID37*/'/*CHEST*/, 15, 15, 15, 15, '15/*itemID37*/'/*CHEST*/, 23, 23, 23, 23, 23, 23, 23, 23, 23],
  ...
  [23, 23, 23, 23, 23, 23, 13, 23, 23, 23, 23, 23, 23, 15, 15, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23],
  ...
  for (let row = 0; row < 20; row++) {
    for (let col = 0; col < 30; col++) {
      ...
      if (typeof tile === 'string') {
        ...
        tileValue = tileValueMatch ? parseInt(tileValueMatch[0]) : 0;

        const itemMatch = tile.match(/itemID(\d+)/);
        if (itemMatch) {
          const itemId = parseInt(itemMatch[1]);
          overlayLayer[row][col] = itemId;
        }
      } else {
        tileValue = tile; // If tile is a number, use it directly
      }

      map[row][col] = tileValue;

      if (isChest) {
        overlayLayer[row][col] = 36;
      }
    }
  }
...
export const items = {
  ...
  25: { name: "Item25", description: "Unknown item", sprite: { x: 368, y: 16 } },
  26: { name: "Item26", description: "Unknown item", sprite: { x: 384, y: 16 } },
  27: { name: "Item27", description: "Unknown item", sprite: { x: 400, y: 16 } },
  33: { name: "Item33", description: "Unknown item", sprite: { x: 416, y: 16 } },
  35: { name: "Item35", description: "Unknown item", sprite: { x: 432, y: 16 } },
  37: { name: "Item37", description: "Unknown item", sprite: { x: 448, y: 16 } },
  41: { name: "Item41", description: "Unknown item", sprite: { x: 464, y: 16 } },
  42: { name: "Item42", description: "Unknown item", sprite: { x: 480, y: 16 } },
  43: { name: "Item43", description: "Unknown item", sprite: { x: 496, y: 16 } },
  45: { name: "Item45", description: "Unknown item", sprite: { x: 512, y: 16 } },
  48: { name: "Item48", description: "Unknown item", sprite: { x: 528, y: 16 } },
  56: { name: "Item56", description: "Unknown item", sprite: { x: 544, y: 16 } },
  61: { name: "Item61", description: "Unknown item", sprite: { x: 560, y: 16 } },
};

export const chestContents = {
  'tilemap1_3_4': [1, 2], // Sword and Potion in chest at row 3, col 4 in tilemap1
  'tilemap2_5_14': [3],   // Shield in chest at row 5, col 14 in tilemap2
  'tilemap3_4_15': [4],   // Key in chest at row 4, col 15 in tilemap3
  'tilemap3_4_20': [2],   // Potion in chest at row 4, col 20 in tilemap3
};