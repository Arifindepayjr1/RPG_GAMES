...
const Game = () => {
  ...
  const npcs = [
    { x: 18 * TILE_SIZE, y: 4 * TILE_SIZE, map: 'tilemap1', type: 'npc', name: 'Mage Anna', dialogue: 'The rift is growing! I n the western cave to seal it. Can you help?', hasTalked: false, frameX: 0, frameY: 0 },
    { x: 5 * TILE_SIZE, y: 6 * TILE_SIZE, map: 'tilemap1', type: 'npc', name: 'Blacksmith Ben', dialogue: 'Greetings! Have you spoken to Mage Anna? She needs a crystal to seal the rift.', hasTalked: false, itemToGive: { id: 2, name: 'Crystal Sword', description: 'A powerful sword forged to defeat the Rift Lord.' }, frameX: 0, frameY: 0 },
