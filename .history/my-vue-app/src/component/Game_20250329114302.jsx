...
const Game = ({ onExitToMenu }) => {
  ...
  // Add new state for victory mode
  ...
  // Update victoryModeRef when victoryMode changes
  useEffect(() => {
  ...
  const resetGameState = () => {
    ...
    setBattleLog([]);
    setVictoryMode(false); // Reset victory mode
  ...
  useEffect(() => {
    ...
    const updateCharacter = (deltaTime) => {
      // Prevent movement if in victory mode
    ...
    // Add a new function to draw the victory screen
    const drawVictoryScreen = () => {
      ...
      // Gradient background for the victory box
      const gradient = ctx.createLinearGradient(boxX, boxY, boxX, boxY + boxHeight);
    ...
    const gameLoop = (timestamp) => {
      ...
      // Draw victory screen if in victory mode
