...
const Game = () => {
  ...
  const npcs = [
    ...
    { x: 5 * TILE_SIZE, y: 6 * TILE_SIZE, map: 'tilemap1', type: 'npc', name: 'Blacksmith Ben', dialogue: 'Greetings! Have you spoken to Mage Anna? al the rift.', hasTalked: false, itemToGive: { id: 2, name: 'Crystal Sword', description: 'A powerful sword forged to defeat the Rift Lord.' }, frameX: 0, frameY: 0 },
