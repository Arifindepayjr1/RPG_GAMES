...
const Game = ({ onExitToMenu }) => {
  ...
  // Add a ref to keep the latest npcs state
  const npcsRef = useRef(npcs);

  // Update npcsRef whenever npcs state changes
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const gameLoop = (timestamp) => {
      ...
      // Draw health bars first to ensure they're at the bottom layer
      console.log('Drawing health bars');
      drawHealthBars();

      // Draw other UI elements on top
