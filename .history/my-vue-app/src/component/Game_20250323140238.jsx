...
const Game = () => {
  ...
  const npcs = [
    { x: 18 * TILE_SIZE, y: 4 * TILE_SIZE, map: 'tilemap1', type: 'npc', name: 'Mage Anna', dialogue: 'The rift is growing! I need a magical crystal from the western cave to seal it. Can you help?', hasTalked: false, frameX: 0, frameY:  },
