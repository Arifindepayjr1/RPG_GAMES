...
import Game from '../src/components/Game'; // Fixed import path (capitalized and corrected directory)
import Menu from '../src/components/Menu'; // Fixed import path (capitalized and corrected directory)
